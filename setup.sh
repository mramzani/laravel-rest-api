...
#    git checkout 5.2
    ...
    php -r "
        ...
        \$arr[\"autoload\"][\"psr-4\"][\"Mramzani\\\\RestAPI\\\\\"] = \"laravel-rest-api/src\";
        \$arr[\"autoload\"][\"psr-4\"][\"Mramzani\\\\RestAPI\\\\Tests\\\\\"] = \"laravel-rest-api/tests\";
...
git clone https://github.com/mramzani/laravel-rest-api
git checkout master
composer du
cd .. || exit
